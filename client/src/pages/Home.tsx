    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'oklch(0.10 0.015 60)' }}>
      ...
      <nav className="flex items-center justify-between px-6 py-3" style={{ borderBottom: '1px solid oklch(0.18 0.02 60)', background: 'oklch(0.09 0.015 60 / 95%)', position: 'sticky', top: 0, zIndex: 50, backdropFilter: 'blur(8px)' }}>
        ...
        <div className="flex items-center gap-4">
          ...
          >COURSES</a>
          {isOwnerOrAdmin && (
            <a href="/admin/leads" style={{ fontFamily: 'Cinzel, serif', fontSize: '0.7rem', letterSpacing: '0.15em', color: 'oklch(0.65 0.10 50)', textDecoration: 'none', transition: 'color 0.2s' }}
              onMouseEnter={e => (e.currentTarget.style.color = 'oklch(0.80 0.14 50)')}
              onMouseLeave={e => (e.currentTarget.style.color = 'oklch(0.65 0.10 50)')}
            >LEADS</a>
          )}
          {!isAuthenticated && (
